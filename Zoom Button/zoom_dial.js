...
const INROOMCONTROL_WEBEXCONTROL_PANELID = 'zoomdialler';
...
const DIALPOSTFIX_WEBEXURL = '@zoomcrc.com';
...
xapi.event.on('UserInterface Extensions Panel Clicked', (event) => {
    if(event.PanelId === INROOMCONTROL_WEBEXCONTROL_PANELID){
         showDialPad("Enter the Zoom 9-digit Meeting ID:" );
    }
});
            ...
            if (match !== null) {
                ...
                if (contains_at_in_dialstring !== null) {
                 ...
                 xapi.command("UserInterface Message TextInput Display", {
                     ...
                     , Text: 'Zoom call number:' + webexnumbertodial
                     , SubmitText: "Dial"
